...
from app.core.deps import get_db_and_user
...
def get_progress(
    ...
    return SituationalService.get_progress(db, current_user)
...
def get_situational_questions(
    ...
    """
    return SituationalService.get_situational_questions(level, db, current_user)
