...
Revision ID: 0fc5df215b8d
Revises: 
Create Date: 2025-10-29 19:30:02.729310
...
def upgrade() -> None:
    ...
    op.create_table('situation_group',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('last_chat_date', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('situation_group_id', sa.Integer(), nullable=False),
    sa.Column('level', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['situation_group_id'], ['situation_group.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('user_situational_progress',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('question_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('user_situational_progress')
